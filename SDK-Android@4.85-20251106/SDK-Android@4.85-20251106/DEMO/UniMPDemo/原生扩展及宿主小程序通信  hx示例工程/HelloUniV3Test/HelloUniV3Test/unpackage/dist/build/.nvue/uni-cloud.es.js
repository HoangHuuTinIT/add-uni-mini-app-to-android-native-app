...
const S = false, b = "app", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b;
I("");
const C = I("[]") || [];
let O = "";
try {
...
var Rt = class {
  ...
  async request(e2, t2 = true) {
    return e2 = this.setupRequest(e2), Promise.resolve().then(() => fe.wrappedRequest(e2, this.adapter.request));
  }
  requestLocal(e2) {
    return new Promise((t2, n2) => {
...
function Xn(e2) {
  ...
  e2.callFunction = function(t3) {
    ...
    let o2, a2;
    if (t3.data = t3.data || {}, o2 = n2, o2 = o2.bind(e2), Gn(t3))
      a2 = n2.call(e2, t3);
    else if (Vn(t3)) {
...
let tr = new class {
  init(e2) {
    ...
    t2 = n2.init(e2), Zs(t2), Xn(t2), function(e3) {
